...
namespace Algorithms.LeetCode.Graphs
{
    ...
    { 
        ...
        public Node CloningGraph(Node node) 
        {
            return Clone(node);
        }   
        ...
        public Node Clone(Node node)
        {
            ...
            foreach(var neighbouringNode in node.neighbors)
            {
                clonedNode.neighbors.Add(Clone(neighbouringNode));
            }            
            return clonedNode;
        }

        //TODO:Write a test wrapper to add and test
    }    
}